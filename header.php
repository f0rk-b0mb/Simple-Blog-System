...
<head>
    ...
    <title>Linux-Engineer.net</title>
...
<div class="w3-bar w3-border">
    ...
    if (isset($_SESSION['username'])) {
        ...
        #echo "<a href='".$url_path ."login.php' class='w3-bar-item w3-red' >Login</a>";
    }
    ?>
</div>
...
<div class="w3-container">
    <form action="<?=$url_path?>search.php" method="GET" class="w3-container">
        ...
        <p>
        <input type="submit" class="w3-btn w3-grey w3-round" value="Search">
        </p>
    </form>
</div>
